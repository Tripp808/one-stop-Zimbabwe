...
import { add_event } from '../../store/acion/index';
...
function AddEventsForm(Props) {
  ...
  let Check_validity = async () => {
    ...
    let obj = {
      ...
      start_Date:  start_Date.getDate() + '/' + JSON.parse(start_Date.getMonth() + 1) + '/' + start_Date.getFullYear(),
      End_Date: End_Date.getDate() + '/' + JSON.parse(End_Date.getMonth() + 1) + '/' + End_Date.getFullYear(),
      UTCPicked: {
    ...
    setLoadingS(true)
    setbutton_show(true)
    await add_event(setLoadingS, setbutton_show, Images, obj, Props.route.params.myBuiness_uid)
      ...
      <>
        ...
        <ScrollView style={{ backgroundColor: '#FFFFFF' }}>
          <View
            ...
            <Text style={styles.navHeading}>Add Events</Text>
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    // add_event: (Images) => (add_event(Images)),
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(AddEventsForm);
