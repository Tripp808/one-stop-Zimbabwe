...
function AddSameCoustomer(Props) {
  ...
  let Check_validity = () => {
    ...
    let user1 = user;
    user1.Coustomer = true;
    firestore()
      .collection("All_Business")
      .add(obj)
      .then((e) => {
        // console.log("response Back",e._documentPath._parts[1]);
  ...
  return (
    <>
      ...
      >
        ...
        <Text style={styles.navHeading}>I am a customer</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(AddSameCoustomer);
