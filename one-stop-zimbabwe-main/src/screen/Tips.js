...
<Text style={{fontSize:12,color:'grey',width:'100%',textAlign:'justify'}}>
  {v.details}
</Text>

<View style={styles.bottomButton}>
<TouchableOpacity activeOpacity={0.7} style={styles.likeComplimant}>
<Text style={{fontSize:10,fontWeight:'bold',color:'#000'}}>
  Like OR Compliment
</Text>
</TouchableOpacity>

<TouchableOpacity activeOpacity={0.7} style={styles.likeComplimant1}>
<Icon3
          onPress={() => Props.navigation.goBack()}
