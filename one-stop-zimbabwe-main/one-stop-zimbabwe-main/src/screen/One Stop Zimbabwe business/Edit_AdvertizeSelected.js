...
function Edit_AdvertizeSelected(Props) {
  ...
  let Check_validity = async () => {
    ...
    let obj = {
      ...
      Map_value: region,
      uid: Edit_Business.uid,
      user_uid: Edit_Business.user_uid
    };
    if (imageData) {
    ...
    <>
      ...
      <ScrollView style={{ flex: 1, width: "100%" }}>
        ...
        >
          ...
          <Text style={styles.navHeading}>Business Details</Text>

          <TouchableOpacity onPress={() => Check_validity()} activeOpacity={0.8} style={styles.sendTouch}>
            <Text style={styles.sendNav}>Continue</Text>
          </TouchableOpacity>
        </View>
        ...
        <View>
          ...
          <Text style={styles.formHeading2}>Country</Text>
          ...
          <Text style={styles.formHeading2}>Business Name</Text>
          ...
          <Text style={styles.formHeading2}>Address</Text>
          ...
          <View style={styles.bar}></View>
          <Text style={styles.formHeading2}>City</Text>
          ...
          <Text style={styles.formHeading2}>Categories</Text>
          ...
          <Text style={styles.formHeading2}>Phone</Text>
          ...
          <Text style={styles.formHeading2}>Minimum Price</Text>
        ...
        <View style={styles.bar}></View>
        <Text style={styles.formHeading2}>Maximum Price</Text>
        ...
        <View style={styles.bar}></View>
          ...
          <Text style={styles.formHeading2}>Website</Text>
          ...
          <Text style={styles.formHeading2}>Menu/Business Catalogue URL</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(Edit_AdvertizeSelected);
